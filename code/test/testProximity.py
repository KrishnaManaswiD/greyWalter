...
def main():
	...
	while True:
        ...
        proximitySensor_1 = wanderer.getSensorData(SensorType.proximity, 1)
        proximitySensor_2 = wanderer.getSensorData(SensorType.proximity, 2)
        proximitySensor_3 = wanderer.getSensorData(SensorType.proximity, 3)
        proximitySensor_4 = wanderer.getSensorData(SensorType.proximity, 4)
