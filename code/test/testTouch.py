...
def main():
	...
	while True:
        ...
        emergencySwitch = wanderer.getSensorData(SensorType.emergencySwitch)
        touchSensor_1 = wanderer.getSensorData(SensorType.touch, 1)
        touchSensor_2 = wanderer.getSensorData(SensorType.touch, 2)
        touchSensor_3 = wanderer.getSensorData(SensorType.touch, 3)
